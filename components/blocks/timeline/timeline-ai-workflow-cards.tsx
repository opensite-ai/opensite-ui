        ...
        <div className="lg:sticky lg:top-24 lg:self-start">
          <div className="max-w-lg">
            ...
            {subheading && (
              <p
                className={cn(
                  "mt-12 text-base text-muted-foreground",
                  subheadingClassName,
                )}
              >
                {subheading}
            ...
            {items.map((item, index) => (
              ...
              >
                <div className="gap-4 sm:gap-6">
                  ...
                  <div
                    className={cn(
                      "absolute top-12 right-12 font-mono text-5xl",
                      stepNumberClassName,
                    )}
                  >
                    0{index + 1}
                  ...
                  <div className="mt-6">
                    <h4
                      className={cn(
                        "mb-2 text-2xl font-semibold text-primary",
                        titleClassName,
                      )}
                    >
                      {item.title}
                    ...
                    <p
                      className={cn(
                        "mt-6 text-xs text-muted-foreground sm:text-base",
                        descriptionClassName,
                      )}
                    >
                      {item.description}
