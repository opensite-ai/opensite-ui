            ...
            <div className={cn("grid gap-6 md:grid-cols-4", phasesClassName)}>
              {phases.map((phase, index) => (
                <div key={phase.id} className={cn("relative space-y-2", phaseClassName)}>
                  ...
                  <div className={cn("absolute top-4 -left-6 z-10 mb-5 flex size-18 items-center justify-center rounded-full bg-background p-1 md:-top-17 md:-left-4", iconClassName)}>
                  ...
                  <div className="pl-13 md:pl-0">
                    <p className={cn("mt-10 text-sm text-muted-foreground", dateClassName)}>
                      {phase.date}
                    </p>
