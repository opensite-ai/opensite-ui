...
interface ContactScheduleFormValues {
  first_name: string;
  last_name: string;
  email: string;
  phone: string;
...
export interface ContactScheduleProps {
  heading?: string;
  description?: string;
  buttonText?: string;
  className?: string;
  formConfig?: PageSpeedFormConfig;
  onSubmit?: (values: ContactScheduleFormValues) => void | Promise<void>;
  onSuccess?: (data: unknown) => void;
  onError?: (error: Error) => void;
}

/**
 * ContactSchedule - Contact form with image background layout.
 *
 * @example
 * ```tsx
 * <ContactSchedule
...
export function ContactSchedule({
  ...
  onSuccess,
  onError,
}: ContactScheduleProps): React.JSX.Element {
  const form = useForm<ContactScheduleFormValues>({
    initialValues: {
      first_name: "",
      last_name: "",
      email: "",
