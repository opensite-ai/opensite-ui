...
interface ContactMaintenanceFormValues {
  first_name: string;
  last_name: string;
  email: string;
  phone: string;
...
export interface ContactMaintenanceProps {
  /** Main heading text */
  ...
  onSubmit?: (values: ContactMaintenanceFormValues) => void | Promise<void>;
  /** Success callback */
...
/**
 * ContactMaintenance - Contact form with image background layout.
 *
 * @example
 * ```tsx
 * <ContactMaintenance
...
export function ContactMaintenance({
  ...
  onSuccess,
  onError,
}: ContactMaintenanceProps): React.JSX.Element {
  const form = useForm<ContactMaintenanceFormValues>({
    initialValues: {
      first_name: "",
      last_name: "",
      email: "",
