...
interface ContactWeddingFormValues {
  first_name: string;
  last_name: string;
  email: string;
  phone: string;
...
export interface ContactWeddingProps {
  heading?: string;
  description?: string;
  buttonText?: string;
  className?: string;
  formConfig?: PageSpeedFormConfig;
  onSubmit?: (values: ContactWeddingFormValues) => void | Promise<void>;
  onSuccess?: (data: unknown) => void;
  onError?: (error: Error) => void;
}

/**
 * ContactWedding - Contact form with image background layout.
 *
 * @example
 * ```tsx
 * <ContactWedding
...
export function ContactWedding({
  ...
  onSuccess,
  onError,
}: ContactWeddingProps): React.JSX.Element {
  const form = useForm<ContactWeddingFormValues>({
    initialValues: {
      first_name: "",
      last_name: "",
      email: "",
