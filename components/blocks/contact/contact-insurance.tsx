...
interface ContactInsuranceFormValues {
  first_name: string;
  last_name: string;
  email: string;
  phone: string;
...
export interface ContactInsuranceProps {
  heading?: string;
  description?: string;
  buttonText?: string;
  className?: string;
  formConfig?: PageSpeedFormConfig;
  onSubmit?: (values: ContactInsuranceFormValues) => void | Promise<void>;
  onSuccess?: (data: unknown) => void;
  onError?: (error: Error) => void;
}

/**
 * ContactInsurance - Contact form with image background layout.
 *
 * @example
 * ```tsx
 * <ContactInsurance
...
export function ContactInsurance({
  ...
  const form = useForm<ContactInsuranceFormValues>({
    initialValues: {
      first_name: "",
      last_name: "",
      email: "",
