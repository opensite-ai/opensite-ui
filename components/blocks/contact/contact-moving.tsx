...
interface ContactMovingFormValues {
  first_name: string;
  last_name: string;
  email: string;
  phone: string;
...
export interface ContactMovingProps {
  /** Main heading text */
  ...
  onSubmit?: (values: ContactMovingFormValues) => void | Promise<void>;
  /** Success callback */
...
/**
 * ContactMoving - Contact form with image background layout.
 *
 * @example
 * ```tsx
 * <ContactMoving
...
export function ContactMoving({
  ...
  const form = useForm<ContactMovingFormValues>({
    initialValues: {
      first_name: "",
      last_name: "",
      email: "",
