...
interface ContactQuoteFormValues {
  first_name: string;
  last_name: string;
  email: string;
  phone: string;
...
export interface ContactQuoteProps {
  ...
  onSubmit?: (values: ContactQuoteFormValues) => void | Promise<void>;
  onSuccess?: (data: unknown) => void;
  onError?: (error: Error) => void;
}

/**
 * ContactQuote - Contact form with image background layout.
 *
 * @example
 * ```tsx
 * <ContactQuote
...
export function ContactQuote({
  ...
  onSuccess,
  onError,
}: ContactQuoteProps): React.JSX.Element {
  const form = useForm<ContactQuoteFormValues>({
    initialValues: {
      first_name: "",
      last_name: "",
      email: "",
