...
interface ContactReportFormValues {
  first_name: string;
  last_name: string;
  email: string;
  phone: string;
...
export interface ContactReportProps {
  /** Main heading text */
  ...
  onSubmit?: (values: ContactReportFormValues) => void | Promise<void>;
  /** Success callback */
...
/**
 * ContactReport - Contact form with image background layout.
 *
 * @example
 * ```tsx
 * <ContactReport
...
export function ContactReport({
  ...
  onSuccess,
  onError,
}: ContactReportProps): React.JSX.Element {
