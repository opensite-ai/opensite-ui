...
interface ContactPartnershipFormValues {
  first_name: string;
  last_name: string;
  email: string;
  phone: string;
...
export interface ContactPartnershipProps {
  /** Main heading text */
  ...
  onSubmit?: (values: ContactPartnershipFormValues) => void | Promise<void>;
  /** Success callback */
...
/**
 * ContactPartnership - Contact form with image background layout.
 *
 * @example
 * ```tsx
 * <ContactPartnership
...
export function ContactPartnership({
  ...
  onSuccess,
  onError,
}: ContactPartnershipProps): React.JSX.Element {
  const form = useForm<ContactPartnershipFormValues>({
    initialValues: {
      first_name: "",
      last_name: "",
      email: "",
