...
interface ContactMapFormValues {
  first_name: string;
  last_name: string;
  email: string;
  phone: string;
...
export interface ContactMapProps {
  ...
  onSubmit?: (values: ContactMapFormValues) => void | Promise<void>;
  /** Success callback */
...
/**
 * ContactMap - Contact form with image background layout.
 *
 * @example
 * ```tsx
 * <ContactMap
...
export function ContactMap({
  ...
  const form = useForm<ContactMapFormValues>({
    initialValues: {
      first_name: "",
      last_name: "",
      email: "",
