...
interface ContactInterviewFormValues {
  first_name: string;
  last_name: string;
  email: string;
  phone: string;
...
export interface ContactInterviewProps {
  ...
  onSubmit?: (values: ContactInterviewFormValues) => void | Promise<void>;
  onSuccess?: (data: unknown) => void;
  onError?: (error: Error) => void;
}

/**
 * ContactInterview - Contact form with image background layout.
 *
 * @example
 * ```tsx
 * <ContactInterview
...
export function ContactInterview({
  ...
  const form = useForm<ContactInterviewFormValues>({
    initialValues: {
      first_name: "",
      last_name: "",
      email: "",
