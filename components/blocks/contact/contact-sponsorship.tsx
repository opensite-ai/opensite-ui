...
interface ContactSponsorshipFormValues {
  first_name: string;
  last_name: string;
  email: string;
  phone: string;
...
export interface ContactSponsorshipProps {
  ...
  onSubmit?: (values: ContactSponsorshipFormValues) => void | Promise<void>;
  /** Success callback */
...
/**
 * ContactSponsorship - Contact form with image background layout.
 *
 * @example
 * ```tsx
 * <ContactSponsorship
...
export function ContactSponsorship({
  ...
  onSuccess,
  onError,
}: ContactSponsorshipProps): React.JSX.Element {
  const form = useForm<ContactSponsorshipFormValues>({
    initialValues: {
      first_name: "",
      last_name: "",
      email: "",
