...
export interface ContactLocationsProps {
  heading?: string;
  description?: string;
  buttonText?: string;
  className?: string;
  formConfig?: PageSpeedFormConfig;
  onSubmit?: (values: ContactLocationsFormValues) => void | Promise<void>;
  onSuccess?: (data: unknown) => void;
  onError?: (error: Error) => void;
}

/**
 * ContactLocations - Contact form with image background layout.
 *
 * @example
 * ```tsx
 * <ContactLocations
...
export function ContactLocations({
  ...
  onSuccess,
  onError,
}: ContactLocationsProps): React.JSX.Element {
  const form = useForm<ContactLocationsFormValues>({
    initialValues: {
      first_name: "",
      last_name: "",
      email: "",
