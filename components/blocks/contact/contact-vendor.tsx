...
interface ContactVendorFormValues {
  first_name: string;
  last_name: string;
  email: string;
  phone: string;
...
export interface ContactVendorProps {
  ...
  onSubmit?: (values: ContactVendorFormValues) => void | Promise<void>;
  onSuccess?: (data: unknown) => void;
  onError?: (error: Error) => void;
}

/**
 * ContactVendor - Contact form with image background layout.
 *
 * @example
 * ```tsx
 * <ContactVendor
...
export function ContactVendor({
  ...
  const form = useForm<ContactVendorFormValues>({
    initialValues: {
      first_name: "",
      last_name: "",
      email: "",
