...
describe("LinkPageGridCards logo banner", () => {
  ...
  it("renders a full-bleed banner as the first Section child and suppresses the medallion", () => {
    ...
    expect(banner).toHaveClass(
      ...
      // in-column header capped to THIS block's content column (max-w-lg),
  ...
  it("maps logoBannerAspect onto the banner band ratio", () => {
    ...
    expect(bannerOf(container)).toHaveClass("aspect-[3/1]", "md:aspect-auto");
    expect(bannerOf(container)).not.toHaveClass("aspect-[16/7]");
    expect(bannerOf(container)).not.toHaveClass("max-h-[50vh]");
    expect(bannerOf(container)).toHaveClass("md:max-w-lg");
    expect(mobileTokens(bannerOf(container) as HTMLElement)).toEqual([
      "relative",
      "left-1/2",
      "flex",
      "w-screen",
    ...
    expect(bannerOf(container)).toHaveClass("aspect-[4/1]", "md:aspect-auto");
    ...
    expect(bannerOf(container)).toHaveClass("aspect-[16/7]", "md:aspect-auto");
