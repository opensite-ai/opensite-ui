      ...
      {isBannerMode && logoBannerImage ? (
        <div
          ...
          className={cn(
            ...
            "mb-8 sm:mb-10",
            // Desktop width cap = THIS block's content column. Unlike the other
            // link-page blocks this one does NOT cap its column with a max-w:
            // the bento grid is "w-full space-y-6" inside "flex flex-col
            // items-center", so its width IS the Section Container's inner box
            // — the very box this banner div also lives in. md:max-w-full is
