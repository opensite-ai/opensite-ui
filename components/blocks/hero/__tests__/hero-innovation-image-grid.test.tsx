...
describe("HeroInnovationImageGrid", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it("renders custom heading", () => {
    render(<HeroInnovationImageGrid heading="Custom Heading" />);
    expect(screen.getByText("Custom Heading")).toBeInTheDocument();
  });

  it("renders custom description", () => {
    render(<HeroInnovationImageGrid description="Custom description text" />);
