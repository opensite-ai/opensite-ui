...
import { HeroHiringAnimatedText } from "../hero-hiring-animated-text";
...
describe("HeroHiringAnimatedText", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it("renders custom description", () => {
    render(<HeroHiringAnimatedText description="Custom description text" />);
    expect(screen.getByText("Custom description text")).toBeInTheDocument();
  });

  it("renders actions when provided", () => {
    const actions = [{ label: "Get Started", href: "/start", variant: "default" as const }];
    render(<HeroHiringAnimatedText actions={actions} />);
