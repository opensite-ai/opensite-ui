...
describe("HeroWelcomeAsymmetricImages", () => {
  ...
  it("renders custom heading", () => {
    render(<HeroWelcomeAsymmetricImages heading="Custom Heading" />);
    expect(screen.getByText("Custom Heading")).toBeInTheDocument();
  });

  it("renders custom description", () => {
    render(<HeroWelcomeAsymmetricImages description="Custom description text" />);
    expect(screen.getByText("Custom description text")).toBeInTheDocument();
  });

  it("renders actions when provided", () => {
    const actions = [{ label: "Get Started", href: "/start", variant: "default" as const }];
    render(<HeroWelcomeAsymmetricImages actions={actions} />);
