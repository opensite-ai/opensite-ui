...
export function HeroDesignSystem3d({
  ...
  return (
    <section className={cn("bg-muted pt-12 font-sans md:pt-20", className)}>
      <div className="mx-auto max-w-396 px-0 sm:px-8">
        <div className="container px-4">
          <div className="mx-auto flex max-w-100 flex-col items-center gap-6 sm:max-w-125 lg:max-w-160">
        ...
        <div className="relative mt-16 aspect-[1.2/1] overflow-hidden sm:-right-[10%] sm:mt-28 sm:aspect-[2.788990826/1]">
