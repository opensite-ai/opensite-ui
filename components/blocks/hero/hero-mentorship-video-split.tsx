              ...
              <div className="flex h-full flex-col justify-between gap-12">
                ...
                <div className="flex max-w-[24.375rem] flex-col gap-6">
                  ...
                  <Pressable
                    ...
                    asButton
                    variant="ghost"
                    className="group relative flex aspect-video h-full w-full max-w-[24.375rem] overflow-hidden rounded-lg bg-accent p-0 transition-all hover:bg-accent"
                  >
                    <AspectRatio ratio={16 / 9} className="flex h-full w-full">
                      ...
                      <div className="m-auto aspect-square z-10">
                        <DynamicIcon name="lucide/play" size={40} className="fill-white stroke-white transition-transform group-hover:scale-125" />
                      </div>
                    </AspectRatio>
                  </Pressable>
                </div>
