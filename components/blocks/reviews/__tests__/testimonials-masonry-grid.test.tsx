...
import { TestimonialsMasonryGrid } from "../testimonials-masonry-grid";
...
describe("TestimonialsMasonryGrid", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  it("renders with default props", () => {
    const { container } = render(<TestimonialsMasonryGrid />);
    const section = container.querySelector("section");
    expect(section).toBeInTheDocument();
  });

  it("applies custom className", () => {
    const { container } = render(<TestimonialsMasonryGrid className="custom-class" />);
    const section = container.querySelector("section");
