...
import { ServicesListMutedCards } from "../services-list-muted-cards";
...
describe("ServicesListMutedCards", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it("routes truthy icons through DynamicIcon and preserves fallback precedence", () => {
    ...
    expect(rawCard?.querySelector(".rounded-lg.p-2")).toBeInTheDocument();
    expect(noIconCard?.querySelector(".rounded-lg.p-2")).toBeInTheDocument();
    expect(
