...
export function CircuitBoardFadeBottomLeft({ className, children }: CircuitBoardFadeBottomLeftProps) {
  return (
    <section
      className={cn(
    ...
    >
      ...
      >
        ...
        <rect width="100%" height="100%" fill="url(#circuit-board-fade-bottom-left)" />
      </svg>
