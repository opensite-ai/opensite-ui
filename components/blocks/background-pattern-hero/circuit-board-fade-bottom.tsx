...
export interface CircuitBoardFadeBottomProps {
  className?: string;
  children?: React.ReactNode;
}

export function CircuitBoardFadeBottom({ className, children }: CircuitBoardFadeBottomProps) {
  return (
    <section
      className={cn(
    ...
    >
      ...
      >
        ...
        <rect width="100%" height="100%" fill="url(#circuit-board-fade-bottom)" />
      </svg>
