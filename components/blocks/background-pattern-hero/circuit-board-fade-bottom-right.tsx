...
export function CircuitBoardFadeBottomRight({ className, children }: CircuitBoardFadeBottomRightProps) {
  return (
    <section
      className={cn(
    ...
    >
      ...
      >
        ...
        <rect width="100%" height="100%" fill="url(#circuit-board-fade-bottom-right)" />
      </svg>
