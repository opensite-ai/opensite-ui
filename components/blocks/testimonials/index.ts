...
export type { TestimonialsSimpleGridProps } from "./testimonials-simple-grid";

export { TestimonialsSliderMinimal } from "./testimonials-slider-minimal";
export type { TestimonialsSliderMinimalProps } from "./testimonials-slider-minimal";
...
export type { TestimonialsParallaxNumberProps } from "./testimonials-parallax-number";

export { TestimonialsMasonryGrid } from "./testimonials-masonry-grid";
export type { TestimonialsMasonryGridProps } from "./testimonials-masonry-grid";

export { TestimonialsLargeQuote } from "./testimonials-large-quote";
export type { TestimonialsLargeQuoteProps } from "./testimonials-large-quote";
