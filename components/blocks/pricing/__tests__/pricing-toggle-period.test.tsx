...
import { PricingTogglePeriod } from "../pricing-toggle-period";
...
describe("PricingTogglePeriod", () => {
  ...
  it("keeps period toggle and feature slot behavior", () => {
    const { rerender } = render(
      <PricingTogglePeriod
        periods={[
          { id: "monthly", label: "Monthly", priceSuffix: "/month" },
          { id: "yearly", label: "Yearly", priceSuffix: "/year" },
        ]}
        plans={[
          {
            name: "Toggle plan",
