...
import { PricingColumnsToggle } from "../pricing-columns-toggle";
...
describe("PricingColumnsToggle", () => {
  ...
  it("preserves truthy actionSlot precedence and the pricing grid layout", () => {
    const { container } = render(
      <PricingColumnsToggle
        plans={[
          {
