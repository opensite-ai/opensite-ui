...
export interface PricingColumnsToggleFeature {
  /**
   * Feature text
   */
...
export interface PricingColumnsTogglePlan {
  /**
   * Plan name
   */
...
export function PricingColumnsToggle({
  sectionId = "pricing-columns-toggle",
  title,
  subtitle,
  monthlyLabel,
  yearlyLabel,
  ...
  const renderPlans = useMemo(() => {
    ...
    return (
      <div className={cn("grid gap-8 md:grid-cols-3", gridClassName)}>
