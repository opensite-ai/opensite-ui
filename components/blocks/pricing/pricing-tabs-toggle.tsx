...
export function PricingTabsToggle({
  ...
  const renderFeatures = useMemo(() => {
    return (plan: PricingTabsTogglePlan) => {
  ...
  }, [plansSlot, plans, gridClassName, popularBadge, cardClassName, popularCardClassName, badgeClassName, iconWrapperClassName, planTitleClassName, planDescriptionClassName, priceClassName, priceIntervalClassName, separatorClassName, billingPeriod, yearlyInterval, monthlyInterval, renderFeatures, renderAction]);
