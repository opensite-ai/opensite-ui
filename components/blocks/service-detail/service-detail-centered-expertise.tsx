...
const defaultExpertise: ServiceExpertiseItem[] = [
  {
...
const defaultServices: ServiceOfferingItem[] = [
...
const defaultRelatedServices: RelatedServiceItem[] = [
  {
...
const defaultContentSections: ServiceContentSection[] = [
  {
