...
**Key Principle**: The `@page-speed/forms` library is completely abstract and framework-agnostic. Platform-specific behavior is implemented through configuration, not through library coupling.
