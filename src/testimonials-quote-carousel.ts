/**
 * TestimonialsQuoteCarousel - Individual export for tree-shaking
 *
 * @example
 * ```ts
 * import { TestimonialsQuoteCarousel } from "@opensite/ui/blocks/reviews/testimonials-quote-carousel";
 * ```
 */
