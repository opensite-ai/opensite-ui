# Contributing to @opensite/ui

Thank you for your interest in contributing! This document provides guidelines and instructions for contributing to @opensite/ui.
...
git clone https://github.com/opensite-ai/page-speed-forms.git
cd page-speed-forms
...
Found a bug? Have a feature request? [Open an issue](https://github.com/opensite-ai/page-speed-forms/issues/new).
...
Ideas for new hooks or improvements? [Start a discussion](https://github.com/opensite-ai/page-speed-forms/discussions).
...
1. Check existing [issues](https://github.com/opensite-ai/page-speed-forms/issues) and [discussions](https://github.com/opensite-ai/page-speed-forms/discussions) to avoid duplicates
...
- **Questions?** [Start a discussion](https://github.com/opensite-ai/page-speed-forms/discussions)
- **Bug reports?** [Open an issue](https://github.com/opensite-ai/page-speed-forms/issues)
...
**Thank you for contributing to @opensite/ui! 🚀**
